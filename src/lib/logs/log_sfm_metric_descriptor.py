...
LOG_SELF_MONITORING_ALL_REQUESTS_METRIC_TYPE = (
    f"{LOG_SELF_MONITORING_METRIC_PREFIX}/all_requests"
)

LOG_SELF_MONITORING_CONNECTIVITY_METRIC_TYPE = (
    f"{LOG_SELF_MONITORING_METRIC_PREFIX}/connectivity_failures"
)

LOG_SELF_MONITORING_TOO_OLD_RECORDS_METRIC_TYPE = (
    f"{LOG_SELF_MONITORING_METRIC_PREFIX}/too_old_records"
)

LOG_SELF_MONITORING_PARSING_ERRORS_METRIC_TYPE = (
    f"{LOG_SELF_MONITORING_METRIC_PREFIX}/parsing_errors"
)

LOG_SELF_MONITORING_TOO_LONG_CONTENT_METRIC_TYPE = (
    f"{LOG_SELF_MONITORING_METRIC_PREFIX}/too_long_content_size"
)

LOG_SELF_MONITORING_PUBLISH_TIME_FALLBACK_METRIC_TYPE = (
    f"{LOG_SELF_MONITORING_METRIC_PREFIX}/publish_time_fallback"
)

LOG_SELF_MONITORING_PROCESSING_TIME_METRIC_TYPE = (
    f"{LOG_SELF_MONITORING_METRIC_PREFIX}/processing_time"
)

LOG_SELF_MONITORING_SENDING_TIME_SIZE_METRIC_TYPE = (
    f"{LOG_SELF_MONITORING_METRIC_PREFIX}/sending_time"
)

LOG_SELF_MONITORING_LOG_INGEST_PAYLOAD_SIZE_METRIC_TYPE = (
    f"{LOG_SELF_MONITORING_METRIC_PREFIX}/log_ingest_payload_size"
)

LOG_SELF_MONITORING_SENT_LOGS_ENTRIES_METRIC_TYPE = (
    f"{LOG_SELF_MONITORING_METRIC_PREFIX}/sent_logs_entries"
)
