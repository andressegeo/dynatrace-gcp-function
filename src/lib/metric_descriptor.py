...
SELF_MONITORING_CONNECTIVITY_METRIC_TYPE = (
    f"{SELF_MONITORING_METRIC_PREFIX}/connectivity"
)

SELF_MONITORING_INGEST_LINES_METRIC_TYPE = (
    f"{SELF_MONITORING_METRIC_PREFIX}/ingest_lines"
)

SELF_MONITORING_REQUEST_COUNT_METRIC_TYPE = (
    f"{SELF_MONITORING_METRIC_PREFIX}/request_count"
)

SELF_MONITORING_PHASE_EXECUTION_TIME_METRIC_TYPE = (
    f"{SELF_MONITORING_METRIC_PREFIX}/phase_execution_time"
)
